...
if language == "English":
    ...
    instructions = (
        ...
        "• First word = term\n"
        "• Second = translation or definition\n\n"
        "Formatting rules:\n"
        "• Single words → use a space:\n"
        "  cat кот\n"
        "• Phrases → use a hyphen (-):\n"
        "  environmental protection - защита окружающей среды\n\n"
        "You can also paste word lists exported from Quizlet.\n\n"
        "Example:\n"
        "cat - кот\n"
        "apple яблоко"
    )
    ...
    instructions = (
        ...
        "Правила ввода:\n"
        "• Если одно слово → используйте пробел:\n"
        "  cat кот\n"
        "• Если фраза → используйте дефис (-):\n"
        "  environmental protection - защита окружающей среды\n\n"
        "Можно вставлять списки слов из Quizlet.\n\n"
        "Пример:\n"
        "cat - кот\n"
        "apple яблоко"
    )
